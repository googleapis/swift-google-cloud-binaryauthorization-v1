...
extension Clients {
  final class ValidationHelperV1Retry: ValidationHelperV1Stub {
    ...
    public init(_ inner: any ValidationHelperV1Stub, options: GoogleGax.ClientOptions) {
      self.inner = inner
    ...
    public func validateAttestationOccurrence(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: ValidateAttestationOccurrenceRequest, o: GoogleGax.RequestOptions) async throws
